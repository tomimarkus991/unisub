    ...
    <Listbox value={value} onChange={setValue}>
      {({ open }) => (
        <div className="relative mt-1">
          <div className="mt-2 xs2:mt-0 mb-2">
            <label htmlFor="select-input">Category</label>
          </div>
          <Listbox.Button
            id="select-input"
            className="relative w-full xs:w-3/4 py-2 pl-3 pr-10 text-left bg-white rounded-lg shadow-md cursor-default focus:outline-none focus-visible:ring-2 
